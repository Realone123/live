...
})(
    {
        ...
        3: [
            function (t, e, i) {
                ...
                (n.prototype = {
                    ...
                    (n.prototype.maxes = { rgb: [255, 255, 255], hsl: [360, 100, 100], hsv: [360, 100, 100], hwb: [360, 100, 100], cmyk: [100, 100, 100, 100] }),
            ...
            function (t, e, i) {
                ...
                function h(t) {
                    var e = t[0] / 255,
                        i = t[1] / 255,
                        a = t[2] / 255;
                    (e = e > 0.04045 ? Math.pow((e + 0.055) / 1.055, 2.4) : e / 12.92), (i = i > 0.04045 ? Math.pow((i + 0.055) / 1.055, 2.4) : i / 12.92), (a = a > 0.04045 ? Math.pow((a + 0.055) / 1.055, 2.4) : a / 12.92);
                ...
                function L(t) {
                    var e,
                        ...
                        s = t[2];
                    return (
                        8 >= n ? ((i = (100 * n) / 903.3), (o = 7.787 * (i / 100) + 16 / 116)) : ((i = 100 * Math.pow((n + 16) / 116, 3)), (o = Math.pow(i / 100, 1 / 3))),
                        ...
                        (t.controllers.bubble = t.DatasetController.extend({
                            ...
                            updateElement: function (t, i, a) {
                                ...
                                e.extend(t, {
                                    ...
                                    _index: i,
                                    _model: {
                                        x: a ? n.getPixelForDecimal(0) : n.getPixelForValue(h, i, this.index, this.chart.isCombo),
                        ...
                        (t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                            ...
                            updateElement: function (t, i, a) {
                                ...
                                e.extend(t, {
                                    ...
                                    _index: i,
                                    _model: { x: d + n.offsetX, y: c + n.offsetY, startAngle: u, endAngle: f, circumference: p, outerRadius: b, innerRadius: m, label: x(g.label, i, n.data.labels[i]) },
                                });
                                var y = t._model;
        ...
        18: [
            function (t, e, i) {
                ...
                e.exports = function (t) {
                    var e = t.helpers;
                    (t.defaults.line = { showLines: !0, hover: { mode: "label" }, scales: { xAxes: [{ type: "category", id: "x-axis-0" }], yAxes: [{ type: "linear", id: "y-axis-0" }] } }),
                        ...
                        e.extend(t.Controller.prototype, {
                            ...
                            resize: function (t) {
                                var i = this.chart.canvas,
                                    ...
                                    o =
                                        this.options.maintainAspectRatio && isNaN(this.chart.aspectRatio) === !1 && isFinite(this.chart.aspectRatio) && 0 !== this.chart.aspectRatio
                            ...
                            buildSurroundingItems: function () {
                                this.options.title && ((this.titleBlock = new t.Title({ ctx: this.chart.ctx, options: this.options.title, chart: this })), t.layoutService.addBox(this, this.titleBlock)),
                                    this.options.legend && ((this.legend = new t.Legend({ ctx: this.chart.ctx, options: this.options.legend, chart: this })), t.layoutService.addBox(this, this.legend));
                            },
                    ...
                    var r = (n.easingEffects = {
                        ...
                        easeInElastic: function (t) {
                            ...
                            return 0 === t
                                ...
                                : 1 === (t /= 1)
                                ? 1
                                : (i || (i = 0.3), a < Math.abs(1) ? ((a = 1), (e = i / 4)) : (e = (i / (2 * Math.PI)) * Math.asin(1 / a)), -(a * Math.pow(2, 10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / i)));
                        },
                        easeOutElastic: function (t) {
                            ...
                            return 0 === t
                                ...
                                : 1 === (t /= 1)
                                ? 1
                                : (i || (i = 0.3), a < Math.abs(1) ? ((a = 1), (e = i / 4)) : (e = (i / (2 * Math.PI)) * Math.asin(1 / a)), a * Math.pow(2, -10 * t) * Math.sin(((1 * t - e) * (2 * Math.PI)) / i) + 1);
                        },
                        easeInOutElastic: function (t) {
                            ...
                            return 0 === t
                                ...
                                : (i || (i = 1 * (0.3 * 1.5)),
                                  ...
                                  1 > t ? -0.5 * (a * Math.pow(2, 10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / i)) : a * Math.pow(2, -10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / i) * 0.5 + 1);
                        },
                ...
                e.exports = function (t) {
                    ...
                    t.layoutService = {
                        ...
                        update: function (t, i, a) {
                            ...
                            function s(t) {
                                t.isHorizontal()
                                    ? ((t.left = t.options.fullWidth ? l : w), (t.right = t.options.fullWidth ? i - l : w + k), (t.top = P), (t.bottom = P + t.height), (P = t.bottom))
                            ...
                            draw: function () {
                                ...
                                if (i.display) {
                                    ...
                                    if (this.isHorizontal()) {
                                        (l.textAlign = "left"), (l.textBaseline = "top"), (l.lineWidth = 0.5), (l.strokeStyle = c), (l.fillStyle = c), (l.font = p);
                                        var m = a.boxWidth,
            ...
            function (t, e, i) {
                ...
                e.exports = function (t) {
                    ...
                    (t.defaults.scale = {
                        display: !0,
                        position: "left",
                        gridLines: { display: !0, color: "rgba(0, 0, 0, 0.1)", lineWidth: 1, drawBorder: !0, drawOnChartArea: !0, drawTicks: !0, tickMarkLength: 10, zeroLineWidth: 1, zeroLineColor: "rgba(0,0,0,0.25)", offsetGridLines: !1 },
                        ...
                        (t.Scale = t.Element.extend({
                            ...
                            fit: function () {
                                ...
                                if (
                                    (l ? (i.width = this.isFullWidth() ? this.maxWidth - this.margins.left - this.margins.right : this.maxWidth) : (i.width = s ? m : 0),
                                    ...
                                    if (((h.fillStyle = m), this.isHorizontal())) {
                                        ...
                                        if (
                                            ...
                                            (F + c.autoSkipPadding) * this.ticks.length > this.width - (this.paddingLeft + this.paddingRight) &&
                                                (n = 1 + Math.floor(((F + c.autoSkipPadding) * this.ticks.length) / (this.width - (this.paddingLeft + this.paddingRight)))),
                        ...
                        draw: function () {
                            ...
                            if (n.display) {
                                ...
                                (a.fillStyle = o(n.fontColor, r.defaultFontColor)),
                                    (a.font = u),
                                    i.isHorizontal() ? ((s = p + (b - p) / 2), (l = g + (m - g) / 2)) : ((s = "left" === n.position ? p + h / 2 : b - h / 2), (l = g + (m - g) / 2), (f = Math.PI * ("left" === n.position ? -0.5 : 0.5))),
                                    a.save(),
                                    a.translate(s, l),
                                    a.rotate(f),
                                    (a.textAlign = "center"),
                        ...
                        (t.Tooltip = t.Element.extend({
                            ...
                            update: function (t) {
                                if (this._active.length) {
                                    ...
                                    i.extend(this._model, {
                                        ...
                                        i.extend(this._model, { x: Math.round(e.x), y: Math.round(e.y), caretPadding: i.getValueOrDefault(e.padding, 2), labelColors: o });
                            ...
                            determineAlignment: function (t) {
                                ...
                                "center" === this._model.yAlign
                                    ...
                                    e(this._model.x)
                                        ? ((this._model.xAlign = "left"), a(this._model.x) && ((this._model.xAlign = "center"), (this._model.yAlign = n(this._model.y))))
                                        : i(this._model.x) && ((this._model.xAlign = "right"), o(this._model.x) && ((this._model.xAlign = "center"), (this._model.yAlign = n(this._model.y))));
                            },
                            ...
                            drawCaret: function (t, e, a, o) {
                                var n,
                                    ...
                                    u = this._chart.ctx;
                                "center" === c.yAlign
                                    ? ("left" === c.xAlign ? ((n = t.x), (r = n - c.caretSize), (s = n)) : ((n = t.x + e.width), (r = n + c.caretSize), (s = n)), (h = t.y + e.height / 2), (l = h - c.caretSize), (d = h + c.caretSize))
                                    : ("left" === c.xAlign
                                      ...
                                      "top" === c.yAlign ? ((l = t.y), (h = l - c.caretSize), (d = l)) : ((l = t.y + e.height), (h = l + c.caretSize), (d = l)));
                        ...
                        (t.elements.Line = t.Element.extend({
                            lineToNextPoint: function (t, e, i, a, o) {
                                ...
                                e._view.skip
                                    ...
                                    : n.bezierCurveTo(t._view.controlPointNextX, t._view.controlPointNextY, e._view.controlPointPreviousX, e._view.controlPointPreviousY, e._view.x, e._view.y);
                            },
                            draw: function () {
                                function t(t) {
                                    r._view.skip || s._view.skip
                                        ? t && n.lineTo(a._view.scaleZero.x, a._view.scaleZero.y)
                                        : n.bezierCurveTo(s._view.controlPointNextX, s._view.controlPointNextY, r._view.controlPointPreviousX, r._view.controlPointPreviousY, r._view.x, r._view.y);
                                }
                                var a = this,
                                    o = this._view,
                                    n = this._chart.ctx,
                                ...
                                n.save(),
                                    this._children.length > 0 &&
                                        ...
                                        this._loop ? t(!0) : (n.lineTo(this._children[this._children.length - 1]._view.x, o.scaleZero), n.lineTo(this._children[0]._view.x, o.scaleZero)),
            ...
            function (t, e, i) {
                ...
                e.exports = function (t) {
                    var e = t.helpers,
                        i = t.defaults.global,
                        a = i.defaultColor;
                    (i.elements.point = { radius: 3, pointStyle: "circle", backgroundColor: a, borderWidth: 1, borderColor: a, hitRadius: 1, hoverRadius: 4, hoverBorderWidth: 1 }),
                    ...
                    var e = t.helpers,
                        ...
                        a = t.Scale.extend({
                            ...
                            getValueForPixel: function (t) {
                                ...
                                return (
                                    o.isHorizontal()
                                        ? ((a = o.width - (o.paddingLeft + o.paddingRight)), (i = o.start * Math.pow(10, ((t - o.left - o.paddingLeft) * n) / a)))
                                        : ((a = o.height - (o.paddingTop + o.paddingBottom)), (i = Math.pow(10, ((o.bottom - o.paddingBottom - t) * n) / a) / o.start)),
                                    i
                                );
                            },
                        });
                                                    ...
                                                    ? e.each(
                                                          ...
                                                          function (t, e) {
                                                              ...
                                                              i.isValid() &&
                                                                  ...
                                                                  n.push(i),
                                                                  r && ((this.firstTick = null !== this.firstTick ? a.min(this.firstTick, i) : i), (this.lastTick = null !== this.lastTick ? a.max(this.lastTick, i) : i)));
                                                          },
                                                          this
                                                      )
                                                    : (n = t),
                                ...
                                buildTicks: function (a) {
                                    ...
                                    (0 !== C || 0 === this.scaleSizeInUnits) &&
                                        (this.options.time.max
                                            ? (this.ticks.push(this.lastTick.clone()), (this.scaleSizeInUnits = this.lastTick.diff(this.ticks[0], this.tickUnit, !0)))
                                            : (this.ticks.push(this.lastTick.clone()), (this.scaleSizeInUnits = this.lastTick.diff(this.firstTick, this.tickUnit, !0)))),
                                        this.ctx.restore();
                                },
                                getLabelForIndex: function (t, e) {
