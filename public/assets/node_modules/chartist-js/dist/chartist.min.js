    ...
    return (
        ...
        (function (a, b, c) {
            ...
            function d(a, d, e, f, g) {
                a instanceof Element ? (this._node = a) : ((this._node = b.createElementNS(c.namespaces.svg, a)), "svg" === a && this.attr({ "xmlns:ct": c.namespaces.ct })),
                    d && this.attr(d),
                    e && this.addClass(e),
        ...
        (function (a, b, c) {
            ...
            function d(a) {
                ...
                (d =
                    void 0 === a.axisX.type
                        ? new c.StepAxis(c.Axis.units.x, b.normalized.series, j, c.extend({}, a.axisX, { ticks: b.normalized.labels, stretch: a.fullWidth }))
                        : a.axisX.type.call(c, c.Axis.units.x, b.normalized.series, j, a.axisX)),
                    (e =
                        void 0 === a.axisY.type
                            ? new c.AutoScaleAxis(c.Axis.units.y, b.normalized.series, j, c.extend({}, a.axisY, { high: c.isNumeric(a.high) ? a.high : a.axisY.high, low: c.isNumeric(a.low) ? a.low : a.axisY.low }))
                                    ...
                                    o.pathElements.forEach(
                                        function (b) {
                                            var h = i
                                                ...
                                                .attr({ "ct:value": [b.data.value.x, b.data.value.y].filter(c.isNumeric).join(","), "ct:meta": c.serialize(b.data.meta) });
                        ...
                        : ((l = m = void 0 === a.axisX.type ? new c.StepAxis(c.Axis.units.x, b.normalized.series, o, { ticks: k }) : a.axisX.type.call(c, c.Axis.units.x, b.normalized.series, o, a.axisX)),
                          (j = n =
                              void 0 === a.axisY.type
                                  ...
                                  : a.axisY.type.call(c, c.Axis.units.y, b.normalized.series, o, c.extend({}, a.axisY, { highLow: d, referenceValue: 0 }))));
                                ...
                                b.normalized.series[e].forEach(
                                    function (g, k) {
                                        ...
                                        if (
                                            ...
                                            (r = a.horizontalBars
                                                ? { x: o.x1 + j.projectValue(g && g.x ? g.x : 0, k, b.normalized.series[e]), y: o.y1 - l.projectValue(g && g.y ? g.y : 0, u, b.normalized.series[e]) }
                                                : { x: o.x1 + l.projectValue(g && g.x ? g.x : 0, u, b.normalized.series[e]), y: o.y1 - j.projectValue(g && g.y ? g.y : 0, k, b.normalized.series[e]) }),
                                            ...
                                            (s = h.elem("line", v, a.classNames.bar).attr({ "ct:value": [g.x, g.y].filter(c.isNumeric).join(","), "ct:meta": c.serialize(w) })),
                                                this.eventEmitter.emit("draw", c.extend({ type: "bar", value: g, index: k, meta: w, series: d, seriesIndex: e, axisX: m, axisY: n, chartRect: o, group: h, element: s }, v));
                                        }
                                    }.bind(this)
                                );
                        }.bind(this)
        ...
        (function (a, b, c) {
            ...
            function e(a) {
                ...
                "%" === m.unit && (m.value *= f / 100),
                    ...
                    (h = "outside" === a.labelPosition || (a.donut && !a.donutSolid) ? f : "center" === a.labelPosition ? 0 : a.donutSolid ? f - m.value / 2 : f / 2),
                    (h += a.labelOffset);
                    ...
                    j.raw.series.forEach(
                        function (e, g) {
                            if (0 !== j.normalized.series[g] || !a.ignoreEmptyValues) {
                                ...
                                a.donut
                                    ? a.donutSolid &&
                                      ((t = f - m.value), (r = c.polarToCartesian(n.x, n.y, t, l - (0 === g || o ? 0 : 0.2))), (s = c.polarToCartesian(n.x, n.y, t, p)), w.line(r.x, r.y), w.arc(t, t, 0, p - l > 180, 1, s.x, s.y))
                                    : w.line(n.x, n.y);
