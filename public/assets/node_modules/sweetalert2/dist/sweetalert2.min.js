!(function (t, e) {
    ...
    var A,
            ...
            t.html ? (at(t.html, e), V(e, "block")) : t.text ? ((e.textContent = t.text), V(e, "block")) : q(e),
                (function (e) {
                    for (
                        var t,
                            n = z(),
                            o = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
                            i = function (t) {
                        ...
                        case "url":
                            (t = T(n, x.input)),
                                "string" == typeof e.inputValue || "number" == typeof e.inputValue
                                    ...
                                    : B(e.inputValue) || C('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(w(e.inputValue), '"')),
                                i(t),
                                (t.type = e.input),
                                V(t);
                            break;
        ...
        pt = function (i) {
            ...
            i.progressSteps && i.progressSteps.length
                ? (V(r),
                  (r.innerHTML = ""),
                  a >= i.progressSteps.length && C("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
        ...
        mt = function (t) {
            ...
            (e = t),
                ...
                (n.className = x.popup),
                e.toast ? (E([document.documentElement, document.body], x["toast-shown"]), E(n, x.toast)) : E(n, x.modal),
                ...
                (function (t) {
                    ...
                    if (e) {
                        if (
                            ("string" == typeof t.backdrop ? (e.style.background = t.backdrop) : t.backdrop || E([document.documentElement, document.body], x["no-backdrop"]),
                            !t.backdrop && t.allowOutsideClick && C('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
                            t.position in x ? E(e, x[t.position]) : (C('The "position" parameter is not valid, defaulting to "center"'), E(e, x.center)),
    ...
    function St() {
        ...
        t.showConfirmButton || (q(e.confirmButton), t.showCancelButton || q(e.actions)),
    ...
    var At = function () {
            null === v.previousBodyPadding &&
                ...
                ((v.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right"))),
        ...
        if (n) {
            ...
            var s = function () {
                et()
                    ...
                    O([document.documentElement, document.body], [x.shown, x["height-auto"], x["no-backdrop"], x["toast-shown"], x["toast-column"]]),
                    tt() &&
                        (null !== v.previousBodyPadding && ((document.body.style.paddingRight = v.previousBodyPadding + "px"), (v.previousBodyPadding = null)),
                        (function () {
                        ...
                        "undefined" != typeof window && Pt() && window.removeEventListener("resize", Lt),
    ...
    var Ht = function (t) {
            ...
            null !== t.onBeforeOpen && "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n),
                ...
                t.heightAuto && t.backdrop && !t.toast && E([document.documentElement, document.body], x["height-auto"]),
                tt() &&
                    ...
                    "undefined" != typeof window && Pt() && (Lt(), window.addEventListener("resize", Lt)),
                    p(document.body.children).forEach(function (t) {
                        t === I() ||
                            (function (t, e) {
                ...
                et() || vt.previousActiveElement || (vt.previousActiveElement = document.activeElement),
                null !== t.onOpen &&
    ...
    var Rt,
        Nt = Object.freeze({
            ...
            _main: function (t) {
                ...
                !(function (e) {
                    e.inputValidator ||
                        ...
                        (!e.target || ("string" == typeof e.target && !document.querySelector(e.target)) || ("string" != typeof e.target && !e.target.appendChild)) &&
                            (C('Target parameter is not valid, defaulting to "body"'), (e.target = "body")),
                ...
                var m = { popup: D(), container: I(), content: z(), actions: Y(), confirmButton: Z(), cancelButton: Q(), closeButton: X(), validationMessage: F(), progressSteps: K() };
                ...
                return new Promise(function (t) {
                                        ...
                                        if (i)
                                            if ((p.disableButtons(), f.input)) {
                                                ...
                                                f.inputValidator
                                                    ...
                                                    ? c(a)
                                                    : (p.enableButtons(), p.showValidationMessage(f.validationMessage));
                                            } else c(!0);
                    ...
                    if (
                        (vt.keydownHandlerAdded && (vt.keydownTarget.removeEventListener("keydown", vt.keydownHandler, { capture: vt.keydownListenerCapture }), (vt.keydownHandlerAdded = !1)),
                        f.toast ||
                                ...
                                return (function (t, e) {
                                    if ((e.stopKeydownPropagation && t.stopPropagation(), "Enter" !== t.key || t.isComposing))
                                        if ("Tab" === t.key) {
                                            ...
                                            -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(t.key)
                                                ? document.activeElement === m.confirmButton && H(m.cancelButton)
                                                    ? m.cancelButton.focus()
                                                    : document.activeElement === m.cancelButton && H(m.confirmButton) && m.confirmButton.focus()
                                                : ("Escape" !== t.key && "Esc" !== t.key) || !0 !== h(e.allowEscapeKey) || (t.preventDefault(), s(g.DismissReason.esc));
                            ...
                            vt.keydownTarget.addEventListener("keydown", vt.keydownHandler, { capture: vt.keydownListenerCapture }),
                            (vt.keydownHandlerAdded = !0)),
                        p.enableButtons(),
                        p.hideLoading(),
                        p.resetValidationMessage(),
                        f.toast && (f.input || f.footer || f.showCloseButton) ? E(document.body, x["toast-column"]) : O(document.body, x["toast-column"]),
                        ...
                        B(f.inputOptions)
                            ...
                            ? l(f.inputOptions)
                            : k("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(w(f.inputOptions)));
