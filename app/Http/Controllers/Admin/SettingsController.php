...
class SettingsController extends Controller
{
    ...
    public function editEmail($id){
        ...
        if($id==1){
            ...
            return view('admin.settings.email-template.add-investors',compact('email','websiteLang','setting'));
        }else if($id==5){
            return view('admin.settings.email-template.verification-edit',compact('email','websiteLang','setting'));
        }else if($id==6){
            return view('admin.settings.email-template.invest-now',compact('email','websiteLang','setting'));
        }else if($id==7){
            return view('admin.settings.email-template.add-property',compact('email','websiteLang','setting'));
        }else if($id==8){
            return view('admin.settings.email-template.admin-approvals',compact('email','websiteLang','setting'));
        }else if($id==9){
            return view('admin.settings.email-template.admin-approvals-rejected',compact('email','websiteLang','setting'));
        }
    }
