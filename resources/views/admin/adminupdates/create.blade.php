                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="col-md-12">
                                     <form action="{{ route('admin.adminupdates.store') }}" method="post" id="hockey">
                                          @csrf
                                     ...
                                     <!--<label for="tb-fname">Select Property</label>-->
                                                                        </div>
                                                                  
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="form-floating mb-3">
                                                                            <input type="text" name="subject"  class="form-control" id="subject" placeholder="Enter Name here">
                                                            ...
                                                            <div class="row p-10">
                                                                           ...
                                                                           <div class="col-md-12">
                                                                                <div class="form-group ">
                                                                                        ...
                                                                                        <textarea id="textarea_editor" name="description" id="description" class=" form-control" rows="15" placeholder="Enter text ..."></textarea>
                                                                                                </div>
                                                                             </div>
