                                        ...
                                        <div class="row m-t-10 p-10">
                                                <div class="col-md-6">
                                                        <div class="form-floating mb-3">
                                                         <select name="user_id" id="user_id"  class="form-control select2" onchange="showHide(this)">
                                                                                  <option hidden Required>Select Investors</option>                              
                                       
                                          @foreach ($users as $item)
                                        <option {{ $investment->user_id==$item->id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->name }}</option>
                                        @endforeach
                                     </select>
                                                       ...
                                                       <div class="col-md-6">
                                                            <div class="form-floating mb-3">
                                                                   <select name="property_id" id="property_id"  class="form-control select2" onchange="showHide(this)">
                                                                                  <option hidden Required>Select Properties</option>                              
                                       @foreach ($properties as $item)
                                        <option {{ $investment->property_id==$item->id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->title }}</option>
                                        @endforeach
                                     </select>
                                                            </div>
                                                           </div>
                                                     ...
                                                     <div class="col-md-6">
                                                                    <div class="form-floating mb-3">
                                                                            <input type="Date" name="date"  id="date" class="form-control" value="{{ $investment->date }}" placeholder="Enter Name here">
                                                                    ...
                                                                    <select name="status" id="status" class="select2 form-control form-select" style="width:100% ! important;" >
                                                                        ...
                                                                        <optgroup>
                                                                             ...
                                                                             <option {{ $investment->status=="Approved" ? 'selected' : '' }} value="Approved">Approved</option>
                                                                              <option {{ $investment->status=="Rejected" ? 'selected' : '' }} value="Pending">Rejected</option>
                                                                         </optgroup>
                                                                     </select>
                                                                </div>
