                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="col-md-12">
                                       <form action="{{ route('admin.admindocuments.update',$documents->id) }}" method="POST" enctype="multipart/form-data" id="hockey">
                                            @csrf
                                            @method('patch')  
                                        ...
                                        <option {{ $documents->property_id==$item->id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->title }}</option>
                                        @endforeach
                                    </select>
                                     ...
                                     <div class="col-lg-6">
                                        ...
                                        <option {{ $documents->user_id==$item->id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                       ...
                                       <div class="col-md-12 m-t-10">
                                             <label class="m-b-10">Tax Documents: </label> 
                                                                                                    <div  class="dropzone"> 
                                                                                                        <div class="fallback">
                                                                                                                <input name="tax_documents[]" type="file" multiple />{{$documents->document}}
                                                                                                            </div>
                                                                                                        </div>
                                                                                       </div>  
                                      <div class="col-md-12 m-t-10">
                                             <label class="m-b-10">Subscriptions Documents: </label> 
                                                                                                    <div  class="dropzone"> 
                                                                                                        <div class="fallback">
                                                                                                                <input name="subscription_documents[]" type="file" multiple />{{$documents->document}}
                                                                                                            </div>
                                                                                                        </div>
                                                                                       </div>                                                     
                                                            <div class="row p-10">
