       ...
       <div class="row">
            <div class="col-lg-3 col-sm-6 col-xs-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center no-block">
                            ...
                            <div class="ms-auto">
                                <h3 class="text-primary mar0">${{$properties->price}}</h3>
                            </div>
                        </div>
                    </div>
                </div>
             ...
             <div class="col-lg-3 col-sm-6 col-xs-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title text-uppercase">Offering Size</h5>
                        <div class="d-flex align-items-center no-block ">
                            <h3 class="mar0"><i class="far fa-chart-bar text-danger"></i></h3>
                            <div class="ms-auto">
                                <h3 class="text-danger mar0">{{$properties->offering_size}}</h3>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-sm-6 col-xs-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title text-uppercase "> Minimum Investment</h5>
                        <div class="d-flex align-items-center no-block">
                            <h3 class="mar0"><i class="fas fa-calendar-alt text-success"></i></h3>
                            <div class="ms-auto">
                                <h3 class="text-success mar0">${{$properties->min_investment}}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- ============================================================== -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                      ...
                                      <video width="300" controls controls>
                                                                        <source src="{{ asset('media/SanJacinto_Video_one.mp4')}}" type="video/mp4">
                                                                        </video>
                    ...
                    <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="card height-view-1">
                                            <div class="card-body">
                                                    <h4 class="card-title fw-500 mr-bottom">Financial Highlights</h4>
                                                    <div class="col-md-12">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="card">
                                                <div class="card-body">
                                                        <h4 class="card-title fw-500 mr-bottom">Key Highlights </h4>
                                                        <div class="col-md-12">
                    ...
                    <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="card ">
                                            <div class="card-body">
                                                    <h4 class="card-title fw-500 mr-bottom">Property Details</h4>
                                                    <div class="col-md-12">
