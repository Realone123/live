            ...
            <div class="card">
                <div class="card-body p-b-0">
                    ...
                    <ul class="nav nav-tabs customtab" role="tablist"  id="myTab">
                        <li class="nav-item"> <a class="nav-link {{old('tab') != 'profile7' ? 'active' : null}}" data-bs-toggle="tab" href="#home7" role="tab">
                            <span class="hidden-sm-up"></span> <span class="hidden-xs-down">
                                Active Investments</span></a> </li>
                        <li class="nav-item"> <a class="nav-link {{old('tab') == 'profile7' ? 'active' : null}}" data-bs-toggle="tab" href="#profile7" role="tab">
                            <span class="hidden-sm-up"></span> <span class="hidden-xs-down">Pending Investments</span></a> </li>
                        <li class="nav-item"> <a class="nav-link {{old('tab') == 'messages7' ? 'active' : null}}" data-bs-toggle="tab" href="#messages7" role="tab"><span class="hidden-sm-up"></span>
                             <span class="hidden-xs-down">Past Investments</span></a> </li>
                    </ul>
                     </div>
            </div>
        </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane {{old('tab') != 'profile7' ? 'active' : 'null'}}" id="home7" role="tabpanel">
                                     <!-- .row -->
                    <div class="row ">
                            @foreach($MyActiveInvestments as $item) 
                                 <!-- item -->
                            <div class="col-lg-4 col-md-6">
                                    <div class="card border-view-1">
                                        ...
                                        <div class="card-body border-top">
                                            ...
                                            <div class="d-flex no-block align-items-center">
                                              <span class="p-10 text-muted"> Invested Date</span>
                                            ...
                                            <div class="d-flex no-block align-items-center">
                                                    <span class="p-10 text-muted">Total Returns</span>
                                                   <span class="ms-auto pull-right">{{ $item->property->total_return }}</span>
                                               </div>
                                               <div class="d-flex no-block align-items-center">
                        ...
                        <div class="tab-pane{{old('tab') == 'profile7' ? 'active' : null}}" id="profile7" role="tabpanel">
                                                <!-- .row -->
                     <div class="row ">
                        @foreach($MyPendingInvestments as $item)
                            <!-- item -->
                            <div class="col-lg-4 col-md-6">
                                    <div class="card border-view-1">
                                        <img class="card-img-top" src="@if($item->property->thumbnail_image) {{  url($item->property->thumbnail_image)   }}@endif" alt="Card image cap">
                                        ...
                                        <div class="card-body border-top">
                                            ...
                                            <div class="d-flex no-block align-items-center">
                                              <span class="p-10 text-muted"> Invested Date</span>
                                                <span class="ms-auto  pull-right">{{ date('M d , Y',strtotime($item->created_at)) }}</span>
                                            </div>
                                            <div class="d-flex no-block align-items-center">
                                                 <span class="p-10 text-muted">Status</span>
                                                <span class="ms-auto color-view-1 pull-right">{{ $item->status }}</span>
                                            </div>
                                            <div class="d-flex no-block align-items-center">
                                                    <span class="p-10 text-muted">Total Returns</span>
                                                   <span class="ms-auto pull-right">{{ $item->property->total_return }}</span>
                                        ...
                                        <div class="card-body border-top">
                                                <div class="d-flex no-block align-items-center">
                                                        <a href="invest-details/{{$item->id}}" class="btn btn-rounded btn-outline-primary  waves-effect waves-light ">View Details </a>
                                                        <a href="{{ url('user/invest-update2/'.$item->id) }}" class="btn btn-rounded btn-outline-primary  waves-effect waves-light ">Updates Investment</a>  
                                                </div>
                                            </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane {{old('tab') == 'messages7' ? 'active' : 'null'}}" id="messages7" role="tabpanel">

                                <div class="row mrtb30">
                                        @foreach($MyPastInvestments as $item)
                            <!-- item -->
                            <div class="col-lg-4 col-md-6">
                                    <div class="card border-view-1">
                                        <img class="card-img-top" src="@if($item->property->thumbnail_image) {{  url($item->property->thumbnail_image)   }}@endif" alt="Card image cap">
                                        ...
                                        <div class="card-body border-top">
                                            ...
                                            <div class="d-flex no-block align-items-center">
                                                 <span class="p-10 text-muted">Status</span>
                                                <span class="ms-auto color-view-2 pull-right">{{ $item->status }}</span>
                                            </div>
                                            <div class="d-flex no-block align-items-center">
                                                    <span class="p-10 text-muted">Total Returns</span>
                                                   <span class="ms-auto pull-right">{{ $item->property->total_return }}</span>
                                        ...
                                        <div class="card-body border-top">
                                                <div class="d-flex no-block align-items-center">
                                                        <a href="invest-details/{{$item->property->id}}" class="btn btn-rounded btn-outline-primary  waves-effect waves-light ">View Details </a>
