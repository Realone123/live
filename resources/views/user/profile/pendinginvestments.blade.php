                    ...
                    <div class="col-md-7 align-self-center text-end">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb justify-content-end">
                                ...
                                <li class="breadcrumb-item active">Pending Investments</li>
                            </ol>
                          </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body p-b-0">
                    ...
                    <div class="tab-content">
                     ...
                     <div class="row ">
                         @if(count($MyPendingInvestments)>0)
                                    ...
                                    <div class="card border-view-1">
                                        ...
                                        <div class="card-body border-top">
                                            ...
                                            <div class="d-flex no-block align-items-center">
                                              <span class="p-10 text-muted"> Invested Date</span>
                                                <span class="ms-auto  pull-right">{{ date('M d , Y',strtotime($item->invested_date)) }}</span>
                                            </div>
                                            <div class="d-flex no-block align-items-center">
                                        ...
                                        <div class="card-body border-top">
                                                <div class="d-flex no-block align-items-center">
                                                        ...
                                                        <a href="{{ url('user/invest-update2/'.$item->id) }}" class="btn btn-rounded btn-outline-primary  waves-effect waves-light ">Edit Investment</a>  
                                                </div>
                                            </div>
                                    </div>
                                </div>
