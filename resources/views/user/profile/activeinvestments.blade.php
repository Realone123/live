            ...
            <div class="card">
                <div class="card-body p-b-0">
                    ...
                    <div class="tab-content">
                                   <!-- .row -->
                    <div class="row ">
                        @if(count($MyActiveInvestments)>0)
                                        ...
                                        <div class="card-body border-top">
                                            ...
                                            <div class="d-flex no-block align-items-center">
                                              <span class="p-10 text-muted"> Invested Date</span>
                                                <span class="ms-auto  pull-right"> @if($item->invested_date)  {{ date('M d , Y',strtotime($item->invested_date)) }} @else {{ date('M d , Y',strtotime($item->created_at)) }} @endif</span>
                                            </div>
                                            <div class="d-flex no-block align-items-center">
                                              <span class="p-10 text-muted"> Approved Date</span>
                                                <span class="ms-auto  pull-right"> @if($item->date)  {{ date('M d , Y',strtotime($item->date))  }} @endif</span>
                                            </div>
                                            <div class="d-flex no-block align-items-center">
