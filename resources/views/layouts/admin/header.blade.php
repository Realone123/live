                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="{{ $adminInfo->image ? url($adminInfo->image) : url($default_image->image) }}" alt="user" class=""> <span class="hidden-md-down">{{ $adminInfo->name }} &nbsp;<i class="fa fa-angle-down"></i></span> </a>
                            <div class="dropdown-menu dropdown-menu-end animated flipInY">
                                ...
                                <!-- text-->
                                <a href="{{ route('admin.profile') }}" class="dropdown-item"><i class="ti-settings"></i> MyAccount</a>
                                <!-- text-->
                                <div class="dropdown-divider"></div>
                                <!-- text-->
                ...
                <nav class="sidebar-nav">
                     <ul id="sidebarnav">
                         ...
                         <li> <a class="waves-effect waves-dark" href="{{ route('admin.dashboard') }}"><i class="icon-speedometer"></i><span class="hide-menu">Dashboard</span></a>
                            ...
                            <li> <a class=" waves-effect waves-dark" href="{{ route('admin.leads') }}"><i class=" fab fa-gripfire"></i><span class="hide-menu">Leads</span></a>
                         </li>
                         <li> <a class=" waves-effect waves-dark" href="{{ route('admin.agents') }}"><i class=" ti-user"></i><span class="hide-menu">Investors</span></a>
                         </li>
                       <li> <a class=" waves-effect waves-dark" href="{{ route('admin.property.index') }}"><i class="ti-bar-chart-alt"></i><span class="hide-menu">Properties</span></a>
                         </li>
                          <li> <a class=" waves-effect waves-dark" href="{{ route('admin.userinvestments.index') }}"><i class=" fas fa-chart-line"></i><span class="hide-menu">Approvals</span></a>
                         </li>
                         <li> <a class=" waves-effect waves-dark" href="{{ route('admin.email.index') }}"><i class=" far fa-envelope"></i><span class="hide-menu">Email</span></a>
                         </li>
                         <li> <a class=" waves-effect waves-dark" href="{{ route('admin.adminupdates.index') }}"><i class=" fas fa-bullhorn"></i><span class="hide-menu">Updates</span></a>
                         </li>
                       <li> <a class="waves-effect waves-dark" href="{{ route('admin.admindocuments.index') }}"><i class="ti-briefcase"></i><span class="hide-menu">Documents</span></a>
                        <!--</li>-->
                         <li> <a class=" waves-effect waves-dark" href="{{ route('admin.reports') }}"><i class=" fas fa-database"></i><span class="hide-menu">Reports</span></a>
                         <!--</li>-->
                         <!--<li> <a class="waves-effect waves-dark" href="services.html"><i class="ti-briefcase"></i><span class="hide-menu">Services</span></a>-->
                         <!--</li>-->
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ route('admin.email.template') }}">Email Template</a></li>
                                 <li><a href="{{ route('admin.country.index') }}">Country</a></li>
                                  <li><a href="{{ route('admin.country-state.index') }}">State</a></li>
                                  <li><a href="{{ route('admin.city.index') }}">City</a></li>
                           </ul>
                        </li>
                         <li> <a class="waves-effect waves-dark" href="{{ route('admin.logout') }}"><i class=" ti-power-off"></i><span class="hide-menu"> Logout </span></a>
                         </li>
                  </ul>
                </nav>
